...
public class SoloMapMenu extends Menu {


    public SoloMapMenu(MenuUtils menuUtils) {
        super(menuUtils);
    }

    @Override
    public String getMenuName() {
        return "§8Mapas - SkyWars Solo";
    }
    ...
    public void handlerMenu(InventoryClickEvent e) {
        ...
        switch (e.getCurrentItem().getType()){
            case ARROW:{
                new SoloNPCMenu(MenuManager.getMenu(player)).open();
                break;
            }
        }
    }
    ...
    public void setMenuItens() {
        ...
        for(Game games : Matches.SOLO.getGames()){
            ...
            inventory.setItem(slots.get(Matches.SOLO.getGames().indexOf(games)), game.getItem());
        }
